...
export default function LinkNotificationBanner({
  title,
  description,
  buttonText,
  href,
  ...
  return (
    ...
    >
      ...
      <Link href={href} legacyBehavior passHref>
        <Button
          variant="default"
          className={`shrink-0 self-stretch whitespace-nowrap rounded-[2px] px-6 py-2 font-bold text-white shadow-none transition-shadow sm:self-center ${isOrange ? 'bg-[#ea580c] hover:bg-[#c2410c]' : 'bg-[#2563eb] hover:bg-[#1d4ed8]'}`}
        >
          {buttonText}
        </Button>
      </Link>
