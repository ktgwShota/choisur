  ...
  return (
    ...
    >
      ...
      <Link href={href} legacyBehavior passHref>
        <Button
          variant="default"
          className={`h-auto shrink-0 self-stretch whitespace-nowrap rounded-[2px] px-4 py-3 text-white shadow-none transition-shadow sm:self-center ${isOrange ? 'bg-[#ea580c] hover:bg-[#c2410c]' : 'bg-[#2563eb] hover:bg-[#1d4ed8]'}`}
        >
          {buttonText}
        </Button>
      </Link>
