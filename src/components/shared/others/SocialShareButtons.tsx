...
export default function SocialShareButtons({ shareText, vertical }: SocialShareButtonsProps) {
  ...
  return (
    <div className={`flex gap-3 ${vertical ? 'flex-col items-center' : 'items-center'}`}>
      <Button
        onClick={shareToX}
        size="icon"
