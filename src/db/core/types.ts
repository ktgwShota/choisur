...
export type ParsedPoll = Omit<PollRaw, 'organizerToken'> & {
...
export type Schedule = Omit<ScheduleBase, 'dates' | 'organizerToken'> & {
  dates: DateOption[];
  responses?: ScheduleResponse[];
};

export type SummaryComment = InferSelectModel<typeof summaryComments>;
export type NewSummaryComment = InferInsertModel<typeof summaryComments>;
