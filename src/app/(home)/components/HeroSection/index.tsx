  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full min-h-auto w-full items-center overflow-hidden md:min-h-screen">
        <div
          className="relative z-10 mx-auto w-full max-w-[970px]"
          style={{
            paddingTop: '80px',
            paddingBottom: '80px',
            paddingLeft: getResponsiveValue(20, 35),
            paddingRight: getResponsiveValue(20, 35),
          }}
        >
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:gap-8">
            {/* Left Area: Text */}
            <div className="flex-1 text-center md:text-left">
              <h1
                className="mb-6 font-extrabold leading-tight"
                style={{
