...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from '@/components/shared/primitives/accordion';
...
export default function FAQAccordionItem({ item, index }: FAQAccordionItemProps) {
  return (
    <AccordionItem
      value={`panel${index}`}
      className="overflow-hidden rounded-[2px] border border-[#e0e0e0] bg-white transition-all duration-200 last:border-b"
      style={{
