...
export const FAQ_ITEMS = [
  ...
  {
    question: 'メニューが開けないです',
    answer:
      'メニューの情報は、作成時のブラウザ内（ローカルストレージ）に保存されています。\nそのため、必ず「イベントを作成した際と同じブラウザ」でアクセスしてください。\n\nシークレットモードで作成された場合や、別のブラウザ・キャッシュを削除された場合は、情報が参照できないためメニューを開くことはできません。（URLの再発行もできません）',
  },
];
