...
export default function ScheduleCreateForm({ initialTitle }: ScheduleFormProps) {
    ...
    await submitWithLoadingAnimation(
      {
        ...
        onSuccess: (result: { id: string; organizerToken: string }) => {
          saveOrganizerToken(result.id, 'schedule', result.organizerToken);
