...
export default function SelectedList() {
  ...
  return (
    <div
      data-testid="schedule-candidate-selected"
      className="rounded-[2px] border border-[#e0e0e0] bg-slate-50"
      style={{
    ...
    >
      <div
        ...
        style={{
          fontSize: getResponsiveValue(14, 15),
          paddingBottom: getResponsiveValue(16, 20),
        }}
      >
        出欠表（仮）
      </div>
                    ...
                    {dateInfo.times.map((time) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="ml-2 flex cursor-pointer items-center border-0 bg-transparent p-0 text-red-500 opacity-60 hover:opacity-100"
                        >
                          <XCircle size={16} />
                        </button>
                      </div>
