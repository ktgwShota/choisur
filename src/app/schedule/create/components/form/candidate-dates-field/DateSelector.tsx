...
import { Calendar as ShadcnCalendar } from '@/components/shared/primitives/calendar';
...
export default function DateSelector() {
    ...
    (
      ...
      return (
        <Button
          ...
          className={cn(
            '!rounded-full group relative flex aspect-square h-auto w-full items-center justify-center border-0 p-0 shadow-none transition-all duration-300',
            isCurrentEditing &&
              isSelected &&
  ...
  return (
    <div className="flex flex-col" style={{ gap: getResponsiveValue(20, 24) }}>
      <div
