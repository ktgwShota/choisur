  ...
  return (
    <>
      <AdvancedPageTitle
        ...
        status={<SocialShareButtons shareText={`${scheduleData.title}の日程調整`} />}
        actions={
          <OrganizerMenu
      ...
      <FadeDialog
        ...
        header={
          <DialogHeader className="py-1">
            <DialogTitle className="text-center font-bold text-lg text-slate-900">
              日程を選択してください
            </DialogTitle>
          </DialogHeader>
        }
              ...
              .map(({ date, time, key }) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative flex w-full cursor-pointer select-none items-center justify-between gap-3 rounded-[2px] border px-4 py-5 text-left transition-all duration-200 ease-out ${
                      isSelected
