            ...
            return (
              ...
              >
                <button
                  ...
                  disabled={!isMyResponse}
                  className={`${isMyResponse ? 'cursor-pointer font-bold text-[13px] text-blue-600 hover:opacity-70' : 'cursor-default font-bold text-[13px] text-slate-900'} flex items-center gap-1 border-0 bg-transparent p-0 text-left`}
                >
                  {response.name}
